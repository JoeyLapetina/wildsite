...
class StreamsControllerTest < ActionController::TestCase
  ...
  test "should create stream" do
    assert_difference('Stream.count') do
      post :create, stream: { body: @stream.body, item: @stream.item, item_link: @stream.item_link, picture: @stream.picture, stream_url: @stream.stream_url, title: @stream.title, video: @stream.video }
    end
  ...
  test "should update stream" do
    put :update, id: @stream, stream: { body: @stream.body, item: @stream.item, item_link: @stream.item_link, picture: @stream.picture, stream_url: @stream.stream_url, title: @stream.title, video: @stream.video }
    assert_redirected_to stream_path(assigns(:stream))
  end
